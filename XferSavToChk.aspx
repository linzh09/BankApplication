<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="XferSavToChk.aspx.cs" Inherits="XferSavToChk" %>
    ...
    <table class="style1">
        <tr>
            <td class="myHeading" colspan="3">
                Transfer Money from Saving to Checking:</td>
        </tr>
        <tr>
            <td>
                &nbsp;&nbsp;</td>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnTransfer" runat="server" CssClass="mainButton" 
                    Text="Transfer to Checkings" onclick="btnTransfer_Click" />
            </td>
        </tr>
        <tr>
            <td>
